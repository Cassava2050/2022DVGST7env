...
# group1 <- trial_tidy_all %>% filter(trial_name %in% c("202177DVGST_momi", "202176DVGST_repe")) %>% 
#   distinct(accession_name) %>% pull() 
# 
# group2 <- trial_tidy_all %>% filter(trial_name %in% c("202257DVGST_momi", "202256DVGST_stom")) %>% 
#   distinct(accession_name) %>% pull() 
# 
# shared_genos <- union(group1, group2) %>% unique()
...
```{r}
if (group == "group1") {
  trial_tidy_all <- trial_tidy_all %>% filter(trial_name %in% c("202271DVGST_ciat", "202151DVGST_ciat", "202177DVGST_momi", "202176DVGST_repe"))
